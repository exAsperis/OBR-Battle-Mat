...
// Keep local battle-mat tiles beneath synchronized map items, including older
// maps whose stored z-indices predate Owlbear's current timestamp-based values.
export const BACKGROUND_Z_INDEX = -1_000_000;
